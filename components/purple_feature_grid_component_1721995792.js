...
Vue.component("purple_feature_grid_component_1721995792", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay up-to-date with the latest blockchain activity through our advanced monitoring system that analyzes new transactions, blocks, and events as they occur.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Customizable Alerting</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Set custom alerts to be notified instantly when specific conditions are met, such as large transactions, contract deployments, or token transfers.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">On-Chain Data Exploration</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Explore and analyze rich on-chain data through our intuitive interface, uncovering valuable insights into blockchain activity, token flows, and network dynamics.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our advanced anomaly detection algorithms to identify suspicious patterns, potential risks, and irregularities within blockchain data.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">API Integration</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Seamlessly integrate our powerful blockchain analysis capabilities into your existing applications and workflows through our robust API.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Create personalized dashboards to visualize and monitor the specific blockchain metrics and data points that matter most to you and your organization.</p></div>
        </div>
    </div>`,
        data() {
            return {
